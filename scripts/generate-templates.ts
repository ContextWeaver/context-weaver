...
const GENRE_MAPPING: GenreMapping = {
  'sci-fi': 'sci-fi',
...
function generateTitle(type: string, genre: string, location: string): string {
  const templates = {
    COMBAT: [
...
function generateNarrative(title: string, type: string, genre: string, location: string, difficulty: string): string {
  const templates = {
    fantasy: [
...
function generateChoices(type: string, difficulty: string): any[] {
...
function adjustForDifficulty(effect: any, difficulty: string): any {
  const multipliers = {
...
function generateTags(type: string, genre: string, location: string): string[] {
...
function generateContextRequirements(genre: string, location: string, difficulty: string): any {
  const requirements: { location: string; career?: string; min_level?: number } = {
    location: location
  };
...
function generateTemplate(id: number, genre: string): any {
